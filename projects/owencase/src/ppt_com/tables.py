...
from utils.com_objects import get_typed_shape
...
def _get_table_shape(slide, name_or_index: Union[str, int]):
    """Find a table shape by name or 1-based index."""
    return get_typed_shape(slide, name_or_index, "HasTable", "table")
...
def add_table(params: AddTableInput) -> str:
    ...
    """
    return execute_json('Failed to add table: ',
            _add_table_impl,
...
def get_table_data(params: GetTableDataInput) -> str:
    ...
    """
    return execute_json('Failed to get table data: ',
...
def set_table_data(params: SetTableDataInput) -> str:
    ...
    """
    return execute_json('Failed to set table data: ',
...
def merge_table_cells(params: MergeTableCellsInput) -> str:
    ...
    """
    return execute_json('Failed to merge cells: ',
...
def add_table_row(params: TableRowInput) -> str:
    ...
    """
    return execute_json('Failed to add table row: ',
            _add_table_row_impl,
            params.slide_index, params.shape_name_or_index,
...
def delete_table_row(params: TableRowInput) -> str:
    ...
    Returns:
        JSON with updated row/column counts.
    """
    return execute_json('Failed to delete table row: ',
...
def add_table_column(params: TableColumnInput) -> str:
    ...
    Returns:
        JSON with updated row/column counts.
    """
    return execute_json('Failed to add table column: ',
...
def delete_table_column(params: TableColumnInput) -> str:
    ...
    Returns:
        JSON with updated row/column counts.
    """
    return execute_json('Failed to delete table column: ',
...
def set_table_style(params: SetTableStyleInput) -> str:
    ...
    """
    return execute_json('Failed to set table style: ',
...
def set_table_layout(params: SetTableLayoutInput) -> str:
    ...
    """
    return execute_json('Failed to set table layout: ',
...
def split_table_cells(params: SplitTableCellsInput) -> str:
    ...
    """
    return execute_json('Failed to split table cells: ',
...
def set_table_borders(params: SetTableBordersInput) -> str:
    ...
    """
    return execute_json('Failed to set table borders: ',
