...
def apply_theme(params: ApplyThemeInput) -> str:
    ...
    """
    return execute_json('Failed to apply theme: ',
            _apply_theme_impl,
            params.theme_path,
        )
...
def get_theme_colors(params: GetThemeColorsInput) -> str:
    ...
    """
    return execute_json('Failed to get theme colors: ', _get_theme_colors_impl)
...
def set_headers_footers(params: SetHeadersFootersInput) -> str:
    ...
    """
    return execute_json('Failed to set headers/footers: ',
