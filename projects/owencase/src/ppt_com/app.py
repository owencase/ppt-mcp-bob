...
def connect_to_powerpoint(params: ConnectInput) -> str:
    ...
    """
    return execute_json('Failed to connect to PowerPoint: ', _connect_impl, params.visible)
...
def get_app_info() -> str:
    ...
    """
    return execute_json('Failed to get app info: ', _get_app_info_impl)
...
def get_active_window_info() -> str:
    ...
    """
    return execute_json('Failed to get window info: ', _get_active_window_info_impl)
...
def list_presentations() -> str:
    ...
    """
    return execute_json('Failed to list presentations: ', _list_presentations_impl)
...
def set_window_state(params: SetWindowStateInput) -> str:
    ...
    """
    return execute_json('Failed to set window state: ', _set_window_state_impl, params.window_state)
