...
def _get_shape(
    ...
    """Find a shape on a slide by stable ID, name, or 1-based index.
...
def register_tools(mcp):
    ...
    async def tool_get_shape_info(params: ShapeIdentifierInput) -> str:
        ...
        Identify the shape by stable ID (shape_id), name, or 1-based index.
    ...
    async def tool_update_shape(params: UpdateShapeInput) -> str:
        ...
        Identify the shape by stable ID, name, or index. Only provided properties are updated.
