...
try:
    ...
    from utils.com_wrapper import pythoncom
...
def _get_chart_shape(slide, name_or_index: Union[str, int]):
    """Find a chart shape by name or 1-based index."""
    return get_typed_shape(slide, name_or_index, "HasChart", "chart")
...
def add_chart(params: AddChartInput) -> str:
    ...
    """
    return execute_json('Failed to add chart: ',
            _add_chart_impl,
...
def set_chart_data(params: SetChartDataInput) -> str:
    ...
    """
    return execute_json('Failed to set chart data: ',
...
def get_chart_data(params: GetChartDataInput) -> str:
    ...
    """
    return execute_json('Failed to get chart data: ',
...
def format_chart(params: FormatChartInput) -> str:
    ...
    """
    return execute_json('Failed to format chart: ',
            _format_chart_impl,
            params.slide_index, params.shape_name_or_index,
...
def format_chart_axis(params: FormatChartAxisInput) -> str:
    ...
    """
    return execute_json('Failed to format chart axis: ',
...
def set_chart_series(params: SetChartSeriesInput) -> str:
    ...
    """
    return execute_json('Failed to set chart series: ',
...
def change_chart_type(params: ChangeChartTypeInput) -> str:
    ...
    """
    return execute_json('Failed to change chart type: ',
