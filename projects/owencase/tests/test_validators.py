...
from ppt_com.themes import SetThemeColorsInput
...
# ============================================================================
# themes.py — explicit colors only
# ============================================================================
class TestSetThemeColorsInput:
    ...
    @pytest.mark.parametrize("removed_field", ["preset", "primary"])
    def test_removed_palette_fields_are_rejected(self, removed_field):
        with pytest.raises(ValidationError):
            SetThemeColorsInput(**{removed_field: "tailwind"})
